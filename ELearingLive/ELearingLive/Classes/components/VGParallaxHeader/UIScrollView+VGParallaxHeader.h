...
#define TranslucentKey @"TranslucentKey"

typedef void(^ScrollCurrentViewDidScroll)(CGFloat contentOffset);

@interface UIScrollView (VGParallaxHeader)

@property (nonatomic, strong) ScrollCurrentViewDidScroll scrollCurrentViewDidScroll;

//@property (nonatomic, copy) void(^scrollCurrentViewDidScroll)(CGFloat contentOffset);
