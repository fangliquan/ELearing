...
- (void)updateConstraints
{
    ...
    if (self.title.length) {
        constraintsString = @"V:|-8-[titleLabel(==30)]-[iconView]-[cancelButton(==30)]-8-|";
    } else {
        constraintsString = @"V:|-8-[titleLabel(==0)]-[iconView]-[cancelButton(==30)]-8-|";
    }
    
    constraints = [NSLayoutConstraint constraintsWithVisualFormat:constraintsString options:0 metrics:nil views:views];
    [self.contentView addConstraints:constraints];
}
